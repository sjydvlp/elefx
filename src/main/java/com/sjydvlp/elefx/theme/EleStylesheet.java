...
public enum EleStylesheet implements Theme {

    DEFAULT("css/DefaultTheme.css"),
    LEGACY("css/legacy/LegacyControls.css"),
    BUTTON("button/EleButton.css"),
    ...
    private static final String RESOURCE_ROOT = "com/sjydvlp/elefx";

    EleStylesheet(String path) {
        this.path = path;
    }
